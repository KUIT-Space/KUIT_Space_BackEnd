...
public class PayRequestTargetJpaEntity extends BaseEntity {
    ...
    @ManyToOne
    private SpaceMember targetMember;           // 정산 대상 멤버
    ...
    @Builder
    private PayRequestTargetJpaEntity(SpaceMember targetMember, PayRequestJpaEntity payRequestJpaEntity, int requestedAmount) {
    ...
    public static PayRequestTargetJpaEntity create(SpaceMember targetMember, PayRequestJpaEntity payRequestJpaEntity, int requestedAmount) {
