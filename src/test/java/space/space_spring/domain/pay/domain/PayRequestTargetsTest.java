...
class PayRequestTargetsTest {
    ...
    void calculateNumberOfSendCompleteTarget1() throws Exception {
        //given
        PayRequestTarget target1 = PayRequestTarget.of(1L, seongjunId, 1L, Money.of(10000), true);
        PayRequestTarget target2 = PayRequestTarget.create(2L, sangjunId, 1L, Money.of(10000));
        PayRequestTarget target3 = PayRequestTarget.create(3L, seohyunId, 1L, Money.of(10000));
        PayRequestTarget target4 = PayRequestTarget.create(4L, kyungminId, 1L, Money.of(10000));
    ...
    void calculateNumberOfSendCompleteTarget2() throws Exception {
        //given
        PayRequestTarget target1 = PayRequestTarget.create(1L, seongjunId, 1L, Money.of(10000));
        PayRequestTarget target2 = PayRequestTarget.create(2L, sangjunId, 1L, Money.of(10000));
        PayRequestTarget target3 = PayRequestTarget.create(3L, seohyunId, 1L, Money.of(10000));
        PayRequestTarget target4 = PayRequestTarget.create(4L, kyungminId, 1L, Money.of(10000));
        PayRequestTargets payRequestTargets = PayRequestTargets.create(List.of(target1, target2, target3, target4));
    ...
    void calculateMoneyOfSendComplete1() throws Exception {
        //given
        PayRequestTarget target1 = PayRequestTarget.create(1L, seongjunId, 1L, Money.of(10000));
        PayRequestTarget target2 = PayRequestTarget.of(2L, sangjunId, 1L, Money.of(20000), true);
        PayRequestTarget target3 = PayRequestTarget.of(3L, seohyunId, 1L, Money.of(30000), true);
        PayRequestTarget target4 = PayRequestTarget.create(4L, kyungminId, 1L, Money.of(10000));
        PayRequestTargets payRequestTargets = PayRequestTargets.create(List.of(target1, target2, target3, target4));
    ...
    void calculateMoneyOfSendComplete2() throws Exception {
        //given
        PayRequestTarget target1 = PayRequestTarget.create(1L, seongjunId, 1L, Money.of(10000));
        PayRequestTarget target2 = PayRequestTarget.create(2L, sangjunId, 1L, Money.of(20000));
        PayRequestTarget target3 = PayRequestTarget.create(3L, seohyunId, 1L, Money.of(30000));
        PayRequestTarget target4 = PayRequestTarget.create(4L, kyungminId, 1L, Money.of(10000));
        PayRequestTargets payRequestTargets = PayRequestTargets.create(List.of(target1, target2, target3, target4));
